...
public class UIManager2 : MonoBehaviour
{
    ...
    {
        if (LevelManager2.Instance == null) return;

        int totalDropsNeeded = LevelManager2.Instance.TotalDropsRequired;
    ...
    public void RefreshUI()
    {
        ...
        {
            UpdateDropsUI(LevelManager2.Instance.CollectedDrops);
        }
    }
}